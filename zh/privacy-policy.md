...
网站没有用户注册功能，不会要求访客直接提交个人信息。但在服务运营过程中，可能会自动收集以下信息：

- IP 地址、浏览器类型、操作系统、访问页面、来源 URL
- 通过 Cookie 等技术产生的使用记录
- 广告展示与点击相关数据
...
- [Naver 隐私政策](https://policy.naver.com/policy/privacy.html)

## 4. Cookie

网站及第三方服务可能使用 Cookie。您可在浏览器设置中拒绝或删除 Cookie，但部分功能可能受限。

## 5. 保存期限

运营者不会在自有服务器上另行保存访客个人信息。第三方服务的保存期限遵循各自政策。
...
部分文章与缩略图可能通过第三方 AI 语言模型与图像生成服务自动撰写、翻译或编辑，具体服务商可能随时间调整。草稿经运营者审核后发布；带有 `ai_generated` 标记的文章会在正文顶部说明。自动生成过程中不会向这些 AI 服务发送访客个人信息。

## 8. 联系方式

- 运营者：Jiwon Min
- 邮箱：<a class="email-obfuscated" href="#" data-email-user="min" data-email-domain="jiwon.io">min@jiwon.io</a>
