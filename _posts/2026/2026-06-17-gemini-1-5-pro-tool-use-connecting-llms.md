...
categories: [AI]
tags: [Gemini, LLM, Tool Use, Function Calling]
description: "Gemini 1.5 Pro의 Tool Use(함수 호출) 기능을 실무에 적용하는 방법을 알아봅니다. 모델이 외부 함수를 인식하고 호출을 요청하는 과정, 설정, 그리고 잠재적 실패 사례를 다룹니다."
---
